...
const help: TranslationStrings = {
  ...
  // files-sync
  'help.guide.files-sync.title': '문서를 Nextcloud 폴더와 맞춰 두기',
  'help.guide.files-sync.goal':
    '여행을 자신의 문서 저장소 폴더에 묶어, 여기서 올린 것이 거기에 놓이고 거기에 정리한 것이 여기에 나타나게 합니다.',
  'help.guide.files-sync.step.1':
    '도구 모음 오른쪽 끝 “휴지통” 옆의 “문서 동기화”를 클릭합니다. 대화 상자가 제목 아래에 여행 이름을 달고 열립니다. 왼쪽 “저장소 연결” 아래에는 관리자가 켜 둔 저장소가 각각 정리 방식을 적은 한 줄과 함께 있습니다. Nextcloud라면 “폴더에 정리”입니다. 오른쪽에는 “아직 연결된 저장소가 없습니다”라고 적혀 있습니다.',
  'help.guide.files-sync.step.2':
    'Nextcloud를 클릭합니다. 연결을 위한 더 작은 대화 상자가 저장소 이름으로 열리고, 맨 위에 계정 비밀번호 대신 앱 비밀번호를 쓰라는 안내가 있습니다.',
  'help.guide.files-sync.step.3':
    '“주소”, “사용자 이름”, 곧 이메일 주소가 아닌 Nextcloud 로그인 이름, 그리고 Nextcloud가 설정, 보안에서 만드는 “앱 비밀번호”를 채웁니다. “기준 폴더”는 선택 사항입니다. TREK이 여행 폴더를 찾는 위치로, 따로 정하지 않으면 /TREK이고 여기서는 /Reisen입니다. 맨 아래의 “자체 서명 인증서 허용”은 그런 인증서를 가진 자체 네트워크의 인스턴스에만 쓰입니다.',
  'help.guide.files-sync.step.4':
    '“연결 테스트”를 클릭합니다. TREK이 입력한 내용으로 저장소에 닿고, 바닥글에는 계정 이름이 들어간 “연결됐습니다. … 계정으로 로그인했습니다”가 적힙니다. 여기서는 admin입니다. 거부된 비밀번호나 닿을 수 없는 주소는 대신 거기에 적히고, 어느 쪽이든 아무것도 저장되지 않습니다.',
  'help.guide.files-sync.step.5':
    '“연결”을 클릭합니다. 연결은 여행과 함께 저장되고, TREK이 “Nextcloud의 어디에 이 여행을 둘까요?”라고 묻습니다. 그 폴더 안에 있는 것만 동기화됩니다. “새로 만들기”는 “만들기”에서 기준 폴더 아래에 폴더를 만들고, 이름은 여행 제목에서 미리 채워집니다. “또는 이미 있는 것 사용하기” 아래에는 이미 있는 폴더들이 있습니다. 하나를 클릭합니다. 여기서는 Autumn in Japan입니다.',
  'help.guide.files-sync.step.6':
    '대화 상자가 돌아옵니다. 왼쪽 “이 여행” 아래에 Nextcloud가 있고, 오른쪽의 그 카드에는 폴더, 마지막으로 실행한 때, “지금 동기화”가 있습니다. 첫 실행은 저절로 시작되고, “지금 동기화”는 원할 때마다 한 번 실행합니다. 실행이 한 번 끝나면 이름 옆의 “아직 동기화하지 않았습니다” 배지는 초록 점으로 바뀌어 마우스를 올리면 “동기화됨”이라고 적히고, 흐름 막대는 TREK과 Nextcloud가 각각 가진 문서를 세며 그 사이에 “저장소로 내보내기”와 “저장소에서 가져오기” 차선이 있습니다. ×로 대화 상자를 닫습니다.',
  'help.guide.files-sync.result':
    '폴더에 이미 있던 문서 두 개가 내 이름으로 올린 것으로 목록 맨 위에 있고, 여행의 모든 문서도 폴더에 있습니다. 이제부터 TREK은 뒤에서 폴더를 확인하고, 폴더는 목록을 따릅니다.',
  'help.guide.files-sync.tip.1':
    '여행을 묶을 수 있는 사람은 여행 소유자나 인스턴스 관리자뿐입니다. 앱 비밀번호가 그 Nextcloud 계정 전체에 닿기 때문입니다. 모든 구성원은 “문서 동기화”를 열고, 카드를 읽고, “지금 동기화”를 누를 수 있습니다.',
  ...
  'help.guide.files-sync.tip.3':
    '카드의 “연결 해제”는 짝을 끝내고 양쪽의 모든 문서를 남깁니다. 두 번째로 묶은 폴더는 새것으로 취급되어 그 안의 모든 것이 다시 들어오므로, “연결 해제” 뒤에는 예전 폴더가 아니라 빈 폴더를 묶으세요.',
