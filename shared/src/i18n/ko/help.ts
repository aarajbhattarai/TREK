...
const help: TranslationStrings = {
  ...
  'help.ctx.trip-collab.bullet.6':
    '“다음 할 일”은 아직 앞에 남은 여행의 다음 여덟 개 지점을, 시간과 거기에 있는 사람과 함께 나열합니다. 하루 계획만 읽을 뿐이고, 시간은 거기에서 정합니다.',
  // write-note
  ...
  'help.guide.close-poll.step.3': '그 옆의 “삭제”가 투표를 없앱니다. 두 번 묻는 것은 없고, 표도 함께 사라집니다.',
  ...
  'help.guide.whats-next.step.1':
    '이 패널은 아직 앞에 남은 여행의 다음 여덟 개 지점을 시간 순으로, 하루마다 하나씩 붙는 제목 아래에 나열합니다. 제목은 “오늘”, “내일” 또는 날짜입니다.',
  ...
  'help.guide.expense-payers.tip.2':
    '지불자가 여럿이면 금액의 합이 총액과 같아야 합니다. 한 사람을 더 포함하면 나머지가 그에 맞춰 다시 배분되고, 맞지 않는 동안에는 지불자 금액의 합계가 총액이어야 한다고 편집기가 알리며 저장을 거부합니다.',
  ...
  'help.guide.expense-from-booking.step.4':
    '다른 지출과 마찬가지로 금액과 누가 냈는지와 분할을 채우고 저장합니다. 예약을 다시 열면 Linked expense 아래에 그것이 보이고, 편집할 연필과 떼어낼 휴지통이 함께 있습니다.',
  ...
  'help.guide.plan-transit.step.2':
    '“출발”과 “도착”은 정류장이나 역을 받습니다. 칸이 아직 비어 있으면 그날 자체의 장소들이 제시되고, 두 글자를 입력하면 대신 시간표의 역을 검색합니다. 두 칸 사이의 “출발지·도착지 교체”는 연결편의 방향을 뒤집습니다.',
  ...
  'help.guide.transport-on-map.step.3':
    '끝의 표식을 클릭하면 지도를 떠나지 않고 예약을 읽을 수 있습니다. 시간, “항공사”와 “항공편 번호”, “예약 코드”, 그리고 메모입니다. “닫기”가 시트를 치웁니다.',
