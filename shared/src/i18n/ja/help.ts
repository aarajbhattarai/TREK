...
const help: TranslationStrings = {
  ...
  'help.ctx.trip-collab.bullet.6':
    '「次にすること」は、まだ先にある旅行の次の8つの立ち寄り先を、時刻とそこにいる人とともに並べます。読むのは日程だけで、時刻はそちらで設定します。',
  // write-note
  ...
  'help.guide.close-poll.step.3': 'その隣の「削除」が投票を消します。二度尋ねるものは何もなく、票も一緒に消えます。',
  ...
  'help.guide.whats-next.step.1':
    'このパネルは、まだ先にある旅行の次の8つの立ち寄り先を、時刻順に、日ごとの見出しの下に並べます。見出しは「今日」「明日」または日付です。',
  ...
  'help.guide.expense-payers.tip.2':
    '支払者が複数のときは、金額が合計と一致している必要があります。もう一人追加すると、ほかの人の金額がそれに合わせて並び直ります。一致していない間は、支払者の金額の合計は合計額である必要があるとエディタが表示し、保存を拒みます。',
  ...
  'help.guide.expense-from-booking.step.4':
    'ほかの支出と同じように金額、支払った人、分割を入力して保存します。予約を開き直すと、Linked expenseの下にそれが出て、編集する鉛筆と外すゴミ箱が付きます。',
  ...
  'help.guide.plan-transit.step.2':
    '「出発地」と「目的地」は停留所または駅を取ります。欄が空のままならその日自身の立ち寄り先が示され、二文字入力すると代わりに時刻表の駅を検索します。二つの欄の間の「入れ替え」は経路を逆向きにします。',
  ...
  'help.guide.transport-on-map.step.3':
    '端のマーカーをクリックすると、地図を離れずに予約を読めます。時刻、「航空会社」と「便名」、「予約コード」、「メモ」です。「閉じる」がシートを片付けます。',
  ...
  'help.guide.roadtrip-stops.result':
    '立ち寄り先は番号の代わりに種類のアイコンを身に着け、滞在より後のすべての到着がそれに合わせて動いています。',
  ...
  'help.guide.roadtrip-alternatives.step.3':
    '項目にカーソルを重ねるとその道が光ります。「現在」と「最速」がどれがどれかを示し、ほかは自分がどれだけ速いか遅いかを示します。',
  ...
  'help.guide.roadtrip-track.step.2':
    'トラックを選びます。それぞれに全長と、この日からどれだけ離れているかが出て、近い順に並びます。',
  ...
  'help.guide.roadtrip-track.step.4':
    'いくつ経由地を置いたか、運転がいまどれだけ近くを保つかを示します。隣のボタンはその経由地をまた落とし、その日をルーターに返します。ダイアログを閉じればトラックは保たれます。',
  'help.guide.roadtrip-track.result':
    'その日の運転は、ルーターが選んだ道ではなくトラックをたどり、「トラック」バッジがどのトラックをたどっているかを示します。',
  'help.guide.roadtrip-track.tip.1':
    'ファイルは「日ごと」で「ファイルをインポート」から読み込み、「トラック（経路付き）」または「パス（ライン）」にチェックを入れます。旅行にトラックが入るまで、バッジには出せるものがありません。',
