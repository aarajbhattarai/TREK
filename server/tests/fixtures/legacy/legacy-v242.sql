-- Legacy-runner install at schema_version 242: the retired db/migrations.ts runner at 417d0445b
-- (the last commit that still had the runner), booted once with no DEMO_MODE, then the canary rows the legacy-baseline
...
INSERT INTO users VALUES(1,'admin','admin@trek.local','fixture-login-disabled','admin',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,NULL,0,'2026-09-24 08:09:23','2026-09-24 08:09:23',NULL,0,NULL,'0.0.0',0,0,NULL,NULL,0,0,NULL);
...
INSERT INTO categories VALUES(1,'Hotel','#3b82f6','🏨',NULL,'2026-09-24 08:09:23');
INSERT INTO categories VALUES(2,'Restaurant','#ef4444','🍽️',NULL,'2026-09-24 08:09:23');
INSERT INTO categories VALUES(3,'Attraction','#8b5cf6','🏛️',NULL,'2026-09-24 08:09:23');
INSERT INTO categories VALUES(4,'Shopping','#f59e0b','🛍️',NULL,'2026-09-24 08:09:23');
INSERT INTO categories VALUES(5,'Transport','#6b7280','🚌',NULL,'2026-09-24 08:09:23');
INSERT INTO categories VALUES(6,'Activity','#10b981','🎯',NULL,'2026-09-24 08:09:23');
INSERT INTO categories VALUES(7,'Bar/Cafe','#f97316','☕',NULL,'2026-09-24 08:09:23');
INSERT INTO categories VALUES(8,'Beach','#06b6d4','🏖️',NULL,'2026-09-24 08:09:23');
INSERT INTO categories VALUES(9,'Nature','#84cc16','🌿',NULL,'2026-09-24 08:09:23');
INSERT INTO categories VALUES(10,'Other','#6366f1','📍',NULL,'2026-09-24 08:09:23');
CREATE TABLE tags (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      user_id INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE,
      name TEXT NOT NULL,
...
CREATE TABLE places (
      ...
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
      updated_at DATETIME DEFAULT CURRENT_TIMESTAMP
    , osm_id TEXT, route_geometry TEXT, route_color TEXT, stop_type TEXT, fill_percent INTEGER, amap_poi_id TEXT, source TEXT);
INSERT INTO places VALUES(1,1,'Canary hotel',NULL,41.3874,2.1686,NULL,NULL,NULL,NULL,'none',NULL,NULL,NULL,NULL,60,NULL,NULL,NULL,NULL,NULL,NULL,'walking','2026-09-24 08:10:00','2026-09-24 08:10:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO places VALUES(2,1,'Morning stop',NULL,41.4036,2.1744,NULL,NULL,NULL,NULL,'none',NULL,NULL,'08:00',NULL,60,NULL,NULL,NULL,NULL,NULL,NULL,'walking','2026-09-24 08:10:00','2026-09-24 08:10:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO places VALUES(3,1,'Evening stop',NULL,41.3809,2.1228,NULL,NULL,NULL,NULL,'none',NULL,NULL,'10:00',NULL,60,NULL,NULL,NULL,NULL,NULL,NULL,'walking','2026-09-24 08:10:00','2026-09-24 08:10:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO places VALUES(4,1,'Late stop',NULL,41.3851,2.1734,NULL,NULL,NULL,NULL,'none',NULL,NULL,'13:00',NULL,60,NULL,NULL,NULL,NULL,NULL,NULL,'walking','2026-09-24 08:10:00','2026-09-24 08:10:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE day_assignments (
      ...
      reservation_datetime TEXT,
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP
    , assignment_time TEXT, assignment_end_time TEXT, leg_transport_mode TEXT, incoming_leg_transport_mode TEXT, end_day INTEGER NOT NULL DEFAULT 0, accommodation_id INTEGER);
INSERT INTO day_assignments VALUES(1,2,2,0,NULL,'none',NULL,NULL,'2026-09-24 08:10:00','09:00',NULL,NULL,NULL,0,NULL);
INSERT INTO day_assignments VALUES(2,2,3,1,NULL,'none',NULL,NULL,'2026-09-24 08:10:00','18:00',NULL,NULL,NULL,0,NULL);
INSERT INTO day_assignments VALUES(3,2,4,2,NULL,'none',NULL,NULL,'2026-09-24 08:10:00','20:00',NULL,NULL,NULL,0,NULL);
INSERT INTO day_assignments VALUES(4,2,1,3,NULL,'none',NULL,NULL,'2026-09-24 08:10:00',NULL,NULL,NULL,NULL,0,1);
...
CREATE TABLE trip_files (
      ...
      description TEXT,
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP
    , note_id INTEGER REFERENCES collab_notes(id) ON DELETE SET NULL, uploaded_by INTEGER REFERENCES users(id) ON DELETE SET NULL, starred INTEGER DEFAULT 0, deleted_at TEXT, message_id INTEGER REFERENCES collab_messages(id) ON DELETE CASCADE);
...
INSERT INTO addons VALUES('roadtrip','Road trip','Drives with stops along the route, driving times, and arrival times that update themselves','trip','Route',0,'{}',7);
INSERT INTO addons VALUES('dawarich','Dawarich','Read visits and recorded routes from your Dawarich instance — suggested journal entries, places and countries you confirm yourself','integration','Dawarich',0,'{}',17);
...
CREATE TABLE visited_countries (
        ...
        created_at DATETIME DEFAULT CURRENT_TIMESTAMP, source TEXT NOT NULL DEFAULT 'manual',
...
CREATE TABLE bucket_list (
        ...
        notes TEXT,
        created_at DATETIME DEFAULT CURRENT_TIMESTAMP
      , target_date TEXT DEFAULT NULL, visited_at TEXT, visited_source TEXT);
CREATE TABLE file_links (
        ...
        created_at DATETIME DEFAULT CURRENT_TIMESTAMP, budget_item_id INTEGER REFERENCES budget_items(id) ON DELETE SET NULL,
...
CREATE TABLE mcp_tokens (
        ...
        created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
        last_used_at DATETIME
      , kind TEXT NOT NULL DEFAULT 'mcp', scope_mode TEXT NOT NULL DEFAULT 'all', api_scopes TEXT);
...
CREATE TABLE journeys (
          ...
          updated_at INTEGER NOT NULL, cover_image TEXT, show_trip_tracks INTEGER NOT NULL DEFAULT 0, show_verdict INTEGER NOT NULL DEFAULT 1, show_mood INTEGER NOT NULL DEFAULT 1, show_weather INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE journey_entries (
          ...
          sort_order INTEGER DEFAULT 0,
          created_at INTEGER NOT NULL,
          updated_at INTEGER NOT NULL, pros_cons TEXT, stats_excluded INTEGER NOT NULL DEFAULT 0, dismissed INTEGER NOT NULL DEFAULT 0, country_code TEXT, source_assignment_id INTEGER,
          FOREIGN KEY (journey_id) REFERENCES journeys(id) ON DELETE CASCADE,
...
INSERT INTO schema_version VALUES(1,242);
...
CREATE TABLE budget_settlements (
        ...
        , currency TEXT, exchange_rate REAL NOT NULL DEFAULT 1, settled_at TEXT);
...
CREATE TABLE school_holiday_countries (
          code TEXT PRIMARY KEY, name TEXT NOT NULL
        );
CREATE TABLE school_holiday_regions (
          id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE dawarich_connections (
          user_id INTEGER PRIMARY KEY REFERENCES users(id) ON DELETE CASCADE,
          url TEXT,
          api_key TEXT,
...
CREATE TABLE dawarich_visit_suggestions (
          id INTEGER PRIMARY KEY AUTOINCREMENT,
          user_id INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE,
...
INSERT INTO document_providers VALUES('paperless','Paperless-ngx','Two-way document sync with a Paperless-ngx instance, scoped by tag','FileText',0,0);
INSERT INTO document_providers VALUES('papra','Papra','Two-way document sync with a Papra organisation, scoped by tag','FileText',0,1);
INSERT INTO document_providers VALUES('nextcloud','Nextcloud','Two-way document sync with a Nextcloud folder over WebDAV','Cloud',0,2);
INSERT INTO document_providers VALUES('opencloud','OpenCloud','Two-way document sync with an OpenCloud space over WebDAV','Cloud',0,3);
INSERT INTO document_providers VALUES('synologydrive','Synology Drive','Two-way document sync with a folder on a Synology NAS','HardDrive',0,4);
CREATE TABLE document_provider_fields (
          id INTEGER PRIMARY KEY AUTOINCREMENT,
...
INSERT INTO document_provider_fields VALUES(1,'paperless','base_url','providerUrl','url','https://paperless.example.com',NULL,1,0,0);
INSERT INTO document_provider_fields VALUES(2,'paperless','api_token','providerApiToken','password','API token','hintPaperlessToken',1,1,1);
INSERT INTO document_provider_fields VALUES(3,'paperless','allow_insecure_tls','allowInsecureTls','checkbox',NULL,NULL,0,0,2);
INSERT INTO document_provider_fields VALUES(4,'papra','base_url','providerUrl','url','https://papra.example.com',NULL,1,0,0);
INSERT INTO document_provider_fields VALUES(5,'papra','api_key','providerApiKey','password','ppapi_…','hintPapraKey',1,1,1);
INSERT INTO document_provider_fields VALUES(6,'papra','organization_id','providerOrganization','text','org_…','hintPapraOrg',1,0,2);
INSERT INTO document_provider_fields VALUES(7,'papra','allow_insecure_tls','allowInsecureTls','checkbox',NULL,NULL,0,0,3);
INSERT INTO document_provider_fields VALUES(8,'nextcloud','base_url','providerUrl','url','https://cloud.example.com',NULL,1,0,0);
INSERT INTO document_provider_fields VALUES(9,'nextcloud','login_name','providerUsername','text','username','hintNextcloudLogin',1,0,1);
INSERT INTO document_provider_fields VALUES(10,'nextcloud','app_password','providerAppPassword','password','app password','hintNextcloudAppPassword',1,1,2);
INSERT INTO document_provider_fields VALUES(11,'nextcloud','base_path','providerBasePath','text','/TREK','hintBasePath',0,0,3);
INSERT INTO document_provider_fields VALUES(12,'nextcloud','allow_insecure_tls','allowInsecureTls','checkbox',NULL,NULL,0,0,4);
INSERT INTO document_provider_fields VALUES(13,'opencloud','base_url','providerUrl','url','https://opencloud.example.com',NULL,1,0,0);
INSERT INTO document_provider_fields VALUES(14,'opencloud','username','providerUsername','text','username',NULL,1,0,1);
INSERT INTO document_provider_fields VALUES(15,'opencloud','app_token','providerAppToken','password','app token','hintOpenCloudToken',1,1,2);
INSERT INTO document_provider_fields VALUES(16,'opencloud','allow_insecure_tls','allowInsecureTls','checkbox',NULL,NULL,0,0,3);
INSERT INTO document_provider_fields VALUES(17,'synologydrive','base_url','providerUrl','url','https://nas.example.com:5001','hintSynologyUrl',1,0,0);
INSERT INTO document_provider_fields VALUES(18,'synologydrive','username','providerUsername','text','username','hintSynologyUser',1,0,1);
INSERT INTO document_provider_fields VALUES(19,'synologydrive','password','providerPassword','password','password',NULL,1,1,2);
INSERT INTO document_provider_fields VALUES(20,'synologydrive','otp_code','providerOTP','text','123456','hintSynologyOtp',0,1,3);
INSERT INTO document_provider_fields VALUES(21,'synologydrive','base_path','providerBasePath','text','/trek','hintBasePath',0,0,4);
INSERT INTO document_provider_fields VALUES(22,'synologydrive','allow_insecure_tls','allowInsecureTls','checkbox',NULL,NULL,0,0,5);
...
CREATE TABLE document_sync_items (
          id INTEGER PRIMARY KEY AUTOINCREMENT,
...
INSERT INTO sqlite_sequence VALUES('document_provider_fields',44);
...
INSERT INTO sqlite_sequence VALUES('day_assignments',4);
CREATE TRIGGER trg_release_stop_on_stay_delete
...
CREATE INDEX idx_place_shadow_created ON place_shadow_picks(created_at);
CREATE INDEX idx_roadtrip_vias_day ON roadtrip_vias(day_id, after_order_index, sequence);
CREATE INDEX idx_roadtrip_day_tracks_place ON roadtrip_day_tracks(place_id);
CREATE UNIQUE INDEX idx_file_links_file_budget ON file_links(file_id, budget_item_id);
CREATE INDEX idx_file_links_budget_item_id ON file_links(budget_item_id);
CREATE INDEX idx_trip_files_message_id ON trip_files(message_id);
CREATE INDEX idx_collab_links_trip ON collab_links(trip_id);
CREATE INDEX idx_route_usage_day ON route_usage_daily(day);
CREATE INDEX idx_school_holiday_periods_region ON school_holiday_periods(region_id);
CREATE INDEX idx_dawarich_suggestions_user_state ON dawarich_visit_suggestions(user_id, state);
CREATE INDEX idx_dawarich_suggestions_trip ON dawarich_visit_suggestions(trip_id);
CREATE INDEX idx_day_assignments_accommodation_id ON day_assignments(accommodation_id);
CREATE INDEX idx_journey_entries_source_assignment ON journey_entries(source_place_id, source_assignment_id);
CREATE INDEX idx_document_connections_trip ON document_connections(trip_id);
CREATE INDEX idx_document_connections_owner ON document_connections(owner_user_id);
CREATE INDEX idx_trip_document_links_trip ON trip_document_links(trip_id);
CREATE INDEX idx_trip_document_links_due ON trip_document_links(sync_enabled, next_attempt_at);
CREATE UNIQUE INDEX idx_trip_document_links_token
          ON trip_document_links(webhook_token) WHERE webhook_token IS NOT NULL;
CREATE UNIQUE INDEX idx_document_sync_items_remote
          ON document_sync_items(link_id, remote_id) WHERE remote_id IS NOT NULL;
CREATE UNIQUE INDEX idx_document_sync_items_file
          ON document_sync_items(link_id, file_id) WHERE file_id IS NOT NULL;
CREATE UNIQUE INDEX idx_document_sync_items_uid
          ON document_sync_items(link_id, trek_doc_uid);
CREATE INDEX idx_document_sync_items_trip_state ON document_sync_items(trip_id, state);
CREATE INDEX idx_document_sync_items_hash ON document_sync_items(link_id, content_sha256);
CREATE INDEX idx_document_sync_items_due ON document_sync_items(link_id, next_attempt_at);
